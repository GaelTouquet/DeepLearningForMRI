...
preprocess_data('D:\\fastMRI_DATA\\singlecoil_train\\',
                name, 'train', input_mask=input_mask)
preprocess_data('D:\\fastMRI_DATA\\singlecoil_val\\',
                name, 'val', input_mask=input_mask)
...
myunet.compile(loss="mean_squared_error",
               optimizer='adam',
               metrics=['mse'])
